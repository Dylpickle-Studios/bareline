...
Create an annotated release tag with `git tag -a v1.2.0 -m "Version 1.2.0"`, then publish it with
`git push origin v1.2.0`. Signed annotated tags expose verification state in the tag list. Do not
